# Unreleased
- Legacy pre-5.0 keychain credentials are now removed once they have been migrated on iOS, instead of being left in the keychain indefinitely. The macOS migration path already did this.
