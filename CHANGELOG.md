# Unreleased
- Fix EMM remediation dialogs being suppressed for the rest of the app's lifetime after a single
  error arrived while no key window was available. The pending-dialog flag is now cleared on every
  exit path.
