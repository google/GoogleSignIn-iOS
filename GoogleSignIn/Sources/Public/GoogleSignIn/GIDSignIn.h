...
/// Starts an interactive sign-in flow on iOS using the provided hint, additional scopes, and tokenClaims.
///
/// The completion will be called at the end of this process.  Any saved sign-in state will be
/// replaced by the result of this flow.  Note that this method should not be called when the app is
/// starting up, (e.g in `application:didFinishLaunchingWithOptions:`); instead use the
...
/// Starts an interactive sign-in flow on iOS using the provided hint, additional scopes, nonce and tokenClaims.
///
/// The completion will be called at the end of this process.  Any saved sign-in state will be
/// replaced by the result of this flow.  Note that this method should not be called when the app is
/// starting up, (e.g in `application:didFinishLaunchingWithOptions:`); instead use the
...
/// Starts an interactive sign-in flow on macOS using the provided hint, additional scopes and tokenClaims.
///
/// The completion will be called at the end of this process.  Any saved sign-in state will be
/// replaced by the result of this flow.  Note that this method should not be called when the app is
/// starting up, (e.g in `application:didFinishLaunchingWithOptions:`); instead use the
...
/// Starts an interactive sign-in flow on macOS using the provided hint, additional scopes, nonce and tokenClaims.
///
/// The completion will be called at the end of this process.  Any saved sign-in state will be
/// replaced by the result of this flow.  Note that this method should not be called when the app is
/// starting up, (e.g in `application:didFinishLaunchingWithOptions:`); instead use the
